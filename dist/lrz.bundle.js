...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UA = (function (userAgent) {
	    ...
	    var ARR_VERSION=IOS_VERSION.split(".");
	    var verSION = 0;
	    if(ARR_VERSION.length>2){
	        verSION = Number(IOS_VERSION[0]+'.'+IOS_VERSION[1]+''+IOS_VERSION[2])
	    }else{
	        verSION = Number(IOS_VERSION);
	    }
	    return {
	        oldIOS: ISOldIOS ? verSION < 8 : false,
		    newIOS: ISOldIOS ? verSION >= 10 : false,
